...
\end{innerlist}
\emph{Research topics}: {Path planning, Multi-objective optimization, Evolutionary computation, Bayesian learning and inference, Robotics}
...
\begin{bibsection}
	...
	\item {\bf Yi, D.}, Seppi, K. and Goodrich, M., \href{}{``Input-to-state stable analysis on Particle Swarm Optimization.''} \emph{2015 GECCO}.
\end{bibsection}
