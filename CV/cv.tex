...
557 Wymount Terrace,  & 801-362-9158 \\
Provo, UT  84604     & \email{daqing.yi@byu.edu}\\
\end{tabular}
...
\item[] Department of Control Science and Engineering,\\
        Tongji University\\
...
\begin{bibsection}
	\item {\bf Yi, D.}, Goodrich, M. and Seppi, K., \href{}{``MORRF$^{*}$ : Sampling-Based Multi-Objective Motion Planning.''} \emph{2015 IJCAI}.

	\item {\bf Yi, D.}, Seppi, K. and Goodrich, M., \href{}{``Input-to-state stable analysis on Particle Swarm Optimization.''} \emph{2015 GECCO} (Accepted).
\end{bibsection}
