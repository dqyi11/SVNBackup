...
def p2MinMax():
    ...
    prob1 += 1.0*p2_a + 2.0*p2_b + 3.0*p2_c <= U1, "Constraint 1"
    prob1 += 0.5*p2_a + 4.0*p2_b + 5.0*p2_c <= U1, "Constraint 2"
    prob1 += 2.5*p2_a + 4.5*p2_b + 6.5*p2_c <= U1, "Constraint 3"
...
def p2MaxMin():
    ...
    prob1 += -1.0*p2_a - 2.0*p2_b - 3.0*p2_c >= U2, "Constraint 1"
    prob1 += -0.5*p2_a - 4.0*p2_b - 5.0*p2_c >= U2, "Constraint 2"
    prob1 += -2.5*p2_a - 4.5*p2_b - 6.5*p2_c >= U2, "Constraint 3"
    prob1 += p2_a + p2_c + p2_b == 1.0, "Probability Constraint"
...
def p1MinMax():
    ...
    prob1 += U2, "Objective Function"
    prob1 += -1.0*p1_a - 2.0*p1_b - 3.0*p1_c <= U2, "Constraint 1"
    prob1 += -0.5*p1_a - 4.0*p1_b - 5.0*p1_c <= U2, "Constraint 2"
    prob1 += -2.5*p1_a - 4.5*p1_b - 6.5*p1_c <= U2, "Constraint 3"
...
def p1MaxMin():
    ...
    prob1 += U1, "Objective Function"
    prob1 += 1.0*p1_a + 2.0*p1_b + 3.0*p1_c >= U1, "Constraint 1"
    prob1 += 0.5*p1_a + 4.0*p1_b + 5.0*p1_c >= U1, "Constraint 2"
    prob1 += 2.5*p1_a + 4.5*p1_b + 6.5*p1_c >= U1, "Constraint 3"
    prob1 += p1_a + p1_c + p1_b == 1.0, "Probability Constraint"
