...
def p2MinMax():
    ...
    prob1 += -p2_paper + p2_scissors <= U1, "Constraint 1"
    prob1 += p2_rock - p2_scissors <= U1, "Constraint 2"
    prob1 += -p2_rock + p2_paper <= U1, "Constraint 3"
    prob1 += p2_rock + p2_scissors + p2_paper == 1.0, "Probability Constraint"
    
    prob1.writeLP("RockPaperScissors_p2MinMax.lp");
    prob1.solve();
...
def p2MaxMin():
    ...
    prob1 += p2_paper - p2_scissors >= U2, "Constraint 1"
    prob1 += -p2_rock + p2_scissors >= U2, "Constraint 2"
    prob1 += p2_rock - p2_paper >= U2, "Constraint 3"
    prob1 += p2_rock + p2_scissors + p2_paper == 1.0, "Probability Constraint"
    
    prob1.writeLP("RockPaperScissors_p2MaxMin.lp");
    prob1.solve();
...
def p1MinMax():
    ...
    prob1 += U2, "Objective Function"
    prob1 += -p1_paper + p1_scissors <= U2, "Constraint 1"
    prob1 += p1_rock - p1_scissors <= U2, "Constraint 2"
    prob1 += -p1_rock + p1_paper <= U2, "Constraint 3"
    prob1 += p1_rock + p1_scissors + p1_paper == 1.0, "Probability Constraint"
    
    prob1.writeLP("RockPaperScissors_p1MinMax.lp");
    prob1.solve();
...
def p1MaxMin():
    ...
    prob1 += U1, "Objective Function"
    prob1 += p1_paper - p1_scissors >= U1, "Constraint 1"
    prob1 += -p1_rock + p1_scissors >= U1, "Constraint 2"
    prob1 += p1_rock - p1_paper >= U1, "Constraint 3"
    prob1 += p1_rock + p1_scissors + p1_paper == 1.0, "Probability Constraint"
