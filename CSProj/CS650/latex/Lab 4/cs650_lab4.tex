...
The features of the object are quantize
...
Chain code \footnote{\url{http://en.wikipedia.org/wiki/Chain_code}} is used to find the contour of a connected component.
