...
if __name__ == '__main__':
    ...
    Net.initChildrenList()
    #print "start sampling"
    
    fileWriter = open('professionalGolfer-list.txt', 'w')
    for n in Net.nodeList:
        fileWriter.write("{}:{}\n".format(n.var, len(n.children)))
    fileWriter.close()
    ...
    fileWriter = open('professionalGolfer-'+time.strftime("%H%M%S")+'.txt', 'w')
    samples = q.doGibbsSampleWithHM(Net, initial, candsd, sampleNum, sampleFrom, hFileWriter=fileWriter)
