...
#include "CCtrlParser.h"
#include <iostream>
#include <fstream>


CCtrlParser::CCtrlParser(const char* fileName) {
...
CCtrlParser::~CCtrlParser() {
	// TODO Auto-generated destructor stub
}

void CCtrlParser::init(istream& in)
{
	string line;
	while(!in.eof())
	{
...
vector<string> CCtrlParser::parseLine(string & line)
{
	vector<string> elementSet;
...
bool CCtrlParser::initData(vector<string> elementSet)
{
