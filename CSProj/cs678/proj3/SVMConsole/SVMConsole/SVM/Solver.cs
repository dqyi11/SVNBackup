...
namespace SVM
{
    ...
    internal class Procedures
    {
        ...
        private static void solve_dc_svc(Problem prob, Parameter param,
        ...
        public static decision_function svm_train_one(Problem prob, Parameter param, double Cp, double Cn)
        {
        ...
        public static void svm_group_classes(Problem prob, int[] nr_class_ret, int[][] label_ret, int[][] start_ret, int[][] count_ret, int[] perm)
        {
            int l = prob.Count;
            int Max_nr_class = 16;
            int nr_class = 0;
        ...
        // Interface functions
        //
        public static Model dsvc_train(Problem prob, Parameter param)
        {
