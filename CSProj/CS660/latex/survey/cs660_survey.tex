...
Both \emph{Zee} and \emph{UnLoc} adopt the idea of active learning, which autonomously generate training set from sensory information to location information.
The dependence on a crowdsourcing process is released by unsupervised learning.
...
\emph{Centaur} utilizes the sensory information fusion.
