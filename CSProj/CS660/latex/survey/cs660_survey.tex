...
Signal strength(RSSI) is used to estimate the distance to the AP, but it is hard to discriminate between multipath reflections and the direct path.
...
The distance estimation is obtained by \emph{EDP} (Energy of the directed path) instead of RSSI, because it is less susceptible to mutipath reflection
...
In \cite{Liu:2013:GEF:2462456.2464450}, 
