...
\centering
\includegraphics[width=0.45\linewidth]{./fig/doc_net_phishing.png}
\label{fig:gene_net_struct:doc_net}
}
\subfigure[Author network]{
\centering
\includegraphics[width=0.45\linewidth]{./fig/auth_net_phishing.png}
...
\subfigure[Document network]{
\centering
\includegraphics[width=0.45\linewidth]{./fig/doc_net_am}
\label{fig:gene_ad_mat:doc_net}
}
\subfigure[Author network]{
\centering
\includegraphics[width=0.45\linewidth]{./fig/auth_net_am}
