...
if __name__ == '__main__':
    ...
    #VisualizeParetoFront(populationFitness, paretoFront, "NSGA-II ZDT3", True, (0.0, 1.0), (-1.0, 1.0))
    VisualizeParetoFront(populationFitness, paretoFront, "NSGA-II ZDT3")
