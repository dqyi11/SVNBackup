...
In planning a path for a task, if the human has a determined mind of how the topology of the path should be, the optimization process can help to find the optimal path in all the paths of a given topology.
