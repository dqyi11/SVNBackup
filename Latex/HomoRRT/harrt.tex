...
By the homotopy-aware exploration process, HA-RRT$^{*}$ can return optimal path with given homotopy constraints and the relevant analyses and applications are given in the next sections.
