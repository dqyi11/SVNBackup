...
When the exploration process is finished, the {\sc MergePaths} procedure will merge the equivalent homotopy classes. 
...
\begin{figure}
	...
	\begin{subfigure}[t]{0.47\linewidth}
		...
		\label{fig:region_label:reference}
	\end{subfigure}  
	%\\
	\begin{subfigure}[t]{0.47\linewidth}
		\centering
