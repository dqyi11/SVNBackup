...
Figure \ref{fig:obs_map:map} gives an example.
...
A single RRT$^{*}$ answers on the problem of the optimal path in the workspace.
In the homotopy-based optimal path-planning problem, 
