...
The improved Jenkin's method shows better efficiency in complex obstacles, especially in avoid of the intersection between the reference frames and 
It also simplifies the boundary. 
Because the reference frames are generated from the rays that rotate along the center point, 
...
compare with voronoi diagram
(1) simpler (2) boundary (3) radius can be sort
