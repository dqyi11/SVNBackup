...
After the reference frames are generated, we could have bidirectional RRT$^{*}$ explore the search space.
...
When the exploration process is finished, a binding process can extract paths from the two tree structures.
