...
As the reference frames decompose the map by the obstacles, they can be generated from the Voronoi diagram.
...
which is described in the {\sc Explore} procedure in this paper.
The only difference is that the string of each branch is updated and there is the {\sc HomotopyCheck}() to check whether the string satisfies the defined grammar.
