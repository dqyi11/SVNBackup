...
\begin{frame}{Performance guarantee}{Anytime algorithm framework}
	...
	\begin{lemma}
		\cite{Yi2014} ``Backtracking'' in Algorithm 1 never \textcolor{red}{underestimates}
	...
	\begin{theorem}
		\cite{Yi2014} The anytime algorithm framework in Algorithm 4 can always find an \textcolor{red}{optimal} solution given enough time.
	\end{theorem}
