...
In section \ref{sec:sys_dynamics}, we examine the convergence of the algorithm.
...
Using a cascade system perspective, the input-to-stable stability analysis can also be applied to moment analysis.
