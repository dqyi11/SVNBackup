...
Since this serial cascade system is ISS, the new position will be bounded somewhere around $ x^{G} (k) $. This implies that the particle will converge toward the $ x^{G} (k) $.
...
By the Lemma 3.5 in \cite{Jiang2001857}, if we can show that a proposed positive definite Lyapunov function is an ISS-Lyapunov function, the system is ISS.
