...
if __name__ == '__main__':
    ...
    for tt in range(trial_time):
        filename1 = "ZDT3-"+str(tt)+"--Div.txt";
        filename2 = "ZDT3-"+str(tt)+"--AD.txt";
        filename3 = "ZDT3-"+str(tt)+"--Spread.txt";
        filename4 = "ZDT3-"+str(tt)+"--Efficiency.txt";
