function [sys,x0,str,ts,simStateCompliance] = mrp_dynamics_ref(t,x,u,flag)
switch flag,
...
w0 = [0.1;0.3;0.5];
sigma0 = [0.0;0.0;0.0];
sigma_S0 = [0, -sigma0(3), sigma0(2); sigma0(3), 0, -sigma0(1); - sigma0(2), sigma0(1),0];
F0=0.5*(0.5*(1-sigma0'*sigma0)*eye(3)-sigma_S0+sigma0*sigma0');
sigma_dot0 = F0 * w0;
x0  = [sigma0; sigma_dot0];
