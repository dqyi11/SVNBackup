...
We consider planning problems: planning with a human-motion constraint, planning with topological requirement, planning with multiple objectives and modeling them from verbal instructions.
These algorithms create a set of robot affordance said that new affordances support complex task definition and flexible decision-making.
}
...
\multirow{2}{*}{ \pbox{20cm}{Verbal instructions with \\ specific grammar restriction \\ can be modeled into \\ path-planning problem. } } & \pbox{20cm}{ The proposed task grammar converts \\ commands into semantic structures. } & \pbox{20cm}{ Empirical study } \\ \cline{2-3} 
...
\multirow{3}{*}{ \pbox{20cm}{Planning problems with \\ consideration of humans' \\ intents can be solved.} }  & \pbox{20cm}{ The solutions of the proposed algorithm \\ asymptotically converge to a set of Pareto \\ optimal paths with multiple objectives. } & \pbox{20cm}{ Theoretical study \\ and simulation } \\ \cline{2-3} 
