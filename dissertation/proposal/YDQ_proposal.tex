...
\newcommand{\Title}{Toward human-in-the-loop robotic decision making}
...
Improvements in robot autonomy is changing the human-robot interaction from low-level manipulation to high-level task-based collaboration~\cite{Yi2014b}.
}
