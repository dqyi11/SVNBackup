...
namespace WingmanPathPlanning.Hexagonal
{
	...
	{
		private Hexagonal.HexagonalMap map;
		...
		public HexagonalMapDrawer(Hexagonal.HexagonalMap map)
		{
			this.Initialize(map, 0, 0);
		}

		public HexagonalMapDrawer(Hexagonal.HexagonalMap map, int xOffset, int yOffset)
		{
		...
		private void Initialize(Hexagonal.HexagonalMap map, int xOffset, int yOffset)
		{
			this.map = map;
